...
- Домен: управление пользователями и аккаунтами (Судя по описанию сервиса мониторинг и управление домом и устройствами требуют авторизации, поэтому авторизация и управление пользователями в отдельном домене)
