...
- Домен: управление домом
	...
	- поддомен: управление электричеством
	- поддомен: безопасность

- Домен: мониторинг
	- поддомен: мониторинг температуры
		- контекст: сбор тепмературы
		- контекст: отображение температуры
	- поддомен: видеонаблюдение
	- поддомен: наблюдение за электрическими показаниями
